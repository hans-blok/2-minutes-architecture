...
**De Paradigmawisseling**Sinds ik met agents werk, zie ik een paradigmawisseling ontstaan. Niet primair omdat we sneller werken, al maak ik tegenwoordig een conceptueel datamodel in een halve dag waar we eerder maanden voor nodig hadden en dan ook met een beter resultaat op veel punten (niet alle).
...
**Het Fundament Verschuift**Jarenlang was ons uitgangspunt helder:
...
**Nieuwe Architectuurvragen**De tegenhanger van deterministische software is probabilistische software. Architectuur zal steeds minder gaan over alles vastleggen en steeds meer over waar onzekerheid mag bestaan, en waar niet.
