...
As an IT architect, everything starts with awareness of the available technologies and patterns. This is necessary to make the most important decisions and define the solutions needed for the organization where you work. Everything is documented in 'your' reference architecture. [CIBIT](https://www.cibit.nl/nl/opleidingen/ "https://www.cibit.nl/nl/opleidingen/") (6) can certainly help you here. [Arcitura](https://www.arcitura.com/) (6) offers good online material that allows you to study at your own pace.
...
Dr. John Ullmen (3) offers a [great course](https://www.linkedin.com/learning/influencing-others/making-influence-work) on influencing. In the booklet entitled 'Why Therefore*'* by Johannes de Geus, Jolanda Bouman (4) you will find tips for arguing. Especially useful if you find yourself in an environment where decisions are made more politically than content-driven.
...
I was lucky enough to be advised to read Victor Grgic's article on 'The Serving Architect', [a must-read for every IT architect working in an Agile environment](http://www.raamstijn.nl/eenblogjeom/index.php/informatiemanagement/4689-dienende-architecten-volgens-viktor-grgic "http://vianovaarchitectura.nl/page/de-dienende-architect") (2). Unfortunately the full article has been removed. Send a message when you have it available!

And finally, you definitely don't want to miss the [cartoon](https://www.youtube.com/watch?v=psAXMqxwol "https://www.youtube.com/watch?v=psAXMqxwol") (2) by David Marquet. He brings it all back to giving intention and offering clarity. You could end up working for one of the best IT departments ever, implementing your architecture.

**Finally**

The 'Software Architect Elevator' by Gregor Hohpe gives a good impression of what it means to be an architect. Are you unsure about purchasing the book? Then watch his video on the topic [Connecting Penthouse and Engine](https://www.youtube.com/watch?v=Zq2VcRZmz78). Once you have watched the video, I would like to test your knowledge with a quiz. See you then!

Sources:

^ Dennis was the closing speaker at the [TFG Innovation Event 2024](https://the-future-group.com/event/inno-2024/).

This article is a translation of an [article](https://www.linkedin.com/pulse/maximizing-value-it-architecture-hans-blok/?trackingId=69kkanJbTBOu9kwof17OOA%3D%3D) that I posted on LinkedIn earlier in 2018. Some new insights have been added.